...
![Login y wizard inicial de pfSense](pfsense-firewall-01-webgui-login.png)
*Login/Wizard inicial, con aviso de contraseña insegura tras la instalación.*

![Dashboard inicial de pfSense](pfsense-firewall-02-dashboard-inicial.png)
...
![Reglas LAN por defecto](pfsense-firewall-03-reglas-lan-default.png)
*Reglas LAN por defecto, antes de restringir el acceso.*

![Reglas LAN restrictivas](pfsense-firewall-04-reglas-lan-restrictivas.png)
...
![Verificación ICMP](pfsense-firewall-05-verificacion-icmp-ping.png)
*Ping ICMP exitoso Desktop → Wazuh Manager (regla permitida funcionando).*

![Verificación HTTPS](pfsense-firewall-06-verificacion-https.png)
*curl HTTPS exitoso, respuesta 302 del Wazuh Dashboard.*

![Verificación bloqueo SSH](pfsense-firewall-07-verificacion-bloqueo-ssh-denegado.png)
...
![Kali alcanza la WAN](pfsense-firewall-08-kali-alcanza-wan-pfsense.png)
...
![Alertas Suricata IDS en pfSense](pfsense-firewall-09-suricata-alertas-webgui.png)
...
![Drop confirmado en la interfaz web](pfsense-firewall-10-suricata-ips-drop-webgui.png)
...
![Dashboard de Wazuh con las alertas de pfSense](pfsense-firewall-12-integracion-wazuh-dashboard.png)
*Dashboard de Wazuh filtrado por rule.id 100050: 18 alertas correlacionadas correctamente.*

![Tabla de eventos en Wazuh](pfsense-firewall-13-integracion-wazuh-events.png)
